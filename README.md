...
* Тип инфоблока, в котором будут храниться данные новостей, должен содержать настроку `Использовать древовидный классификатор элементов по разделам` включенной. Таким образом, в списке новостей на административной части сайта будет возможность создавать разделы (появится кнопка их создавать)
